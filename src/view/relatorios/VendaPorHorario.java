...
/**
 * Classe monta um grafico para exibir quantas vendas tivera em certos horarios de sessoes
 *
 * @author eduardo
 */
public class VendaPorHorario extends Preloader {
    ...
    @Override public void start(Stage stage) {
        ...
        scene.getStylesheets().add(VendaPorHorario.class.getResource("../../css/styleGrafic.css").toExternalForm());
