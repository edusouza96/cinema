 ...
 * @see procurarPorNome(String nome)
 * : procura uma linha de dados através de um nome valido inserido
 * @see procurarPorGenero(String genero)
 * : retorna uma lista de dados através de um genero valido inserido
 */
